...
| Referencia y sustitución léxica | 4 | **4** — Sin errores de referencia: sustituye por pronombre, sinónimo o hiperónimo cada palabra ya usada en la oración anterior<br>**3** — Hasta 1 repetición sin sustituir, teniendo sustituto evidente<br>**2** — 2 o 3 repeticiones sin sustituir, teniendo sustituto evidente<br>**1** — 4 o 5 repeticiones sin sustituir, con alguna sustituida en el resto del texto<br>**0** — 6 o más repeticiones sin sustituir: repite el mismo sustantivo a lo largo de todo el texto |
...
| Referencia y sustitución léxica | 2 | **2** — Sustituye las repeticiones mediante nominalización o hiperónimo de significado abstracto, y todos los referentes son recuperables<br>**1.5** — Sustituye las repeticiones mediante sinónimos y pronombres, sin recurrir a la nominalización ni al hiperónimo, y todos los referentes son recuperables<br>**1** — Hasta 1 error de referencia: una repetición sin sustituir o un referente que exige releer<br>**0.5** — 2 o 3 errores de referencia, entre repeticiones sin sustituir y referentes que exigen releer<br>**0** — 4 o más errores de referencia: repite el mismo sustantivo en oraciones consecutivas a lo largo del texto |
...
| Componente | Máx. | Bandas |
|---|---|---|
| Planificación propia | 4 | **4** — Entrega un esquema previo propio con la tesis y el orden de los argumentos<br>**3** — Entrega un esquema previo que solo lista ideas, sin orden argumentativo<br>**2** — Entrega notas sueltas previas, sin esquema<br>**1** — Entrega el esquema del modelo de clase, sin orden propio<br>**0** — No hay rastro de trabajo previo al texto |
...
| Atribución y propiedad intelectual | 2 | **2** — Cita el origen de cada dato en el punto del texto donde aparece y recoge la referencia completa de cada fuente<br>**1.5** — Cita el origen de cada dato en el punto del texto donde aparece y deja incompleta la referencia de alguna fuente<br>**1** — Indica las fuentes al final, sin ligar cada dato a la suya<br>**0.5** — Menciona alguna fuente de pasada, sin sistema<br>**0** — Traslada pasajes de la fuente sin señalarlos |
| Valoración de la fiabilidad | 4 | **4** — Valora la fiabilidad de cada fuente a partir de su autoría, su fecha o su propósito, y lo explicita en el texto<br>**3** — Valora la fiabilidad de una fuente, sin explicitar en qué se apoya<br>**2** — Emplea datos y opiniones de la fuente con el mismo valor de prueba<br>**1** — Nombra el autor o la fecha de una fuente, sin sacar de ahí ninguna consecuencia<br>**0** — Emplea cualquier fuente sin valorar de dónde procede |
...
| Corrección gramatical | 2 | **2** — Sin errores de concordancia ni de construcción de la oración<br>**1.5** — 1 o 2 errores que no impiden la comprensión<br>**1** — De 3 a 5 errores, o alguna oración que hay que releer para reconstruir<br>**0.5** — De 6 a 12 errores, y la lectura se detiene para rehacer la oración<br>**0** — Errores sistemáticos que obligan a reconstruir el sentido |
| Precisión léxica y vocación de estilo | 4 | **4** — Selecciona el término valorativo preciso y emplea algún recurso de estilo propio del ensayo (interrogación retórica, variación sintáctica)<br>**3** — Selecciona términos precisos, pero sin recurso de estilo alguno más allá de lo correcto<br>**2** — Recurre a términos de significado impreciso con sustituto evidente<br>**1** — Emplea términos imprecisos y alguna palabra comodín<br>**0** — El texto se sostiene sobre palabras comodín |
...
| Componente | Máx. | Bandas |
|---|---|---|
| Planificación propia | 4 | **4** — Entrega un guion previo con la tesis, los argumentos y la objeción prevista<br>**3** — Entrega un guion previo que solo lista ideas, sin línea argumentativa<br>**2** — Entrega notas sueltas previas, sin guion<br>**1** — Entrega el guion del modelo de clase, sin tesis propia<br>**0** — No hay rastro de trabajo previo al texto |
...
| Justificación con metalenguaje | 2 | **2** — Justifica 2 o más cambios con metalenguaje específico, explicando el problema que resuelven y el efecto persuasivo que persiguen<br>**1.5** — Justifica 2 o más cambios con metalenguaje específico y nombra el efecto persuasivo en uno solo de ellos<br>**1** — Justifica los cambios con metalenguaje, pero solo señala el problema que resuelven<br>**0.5** — Nombra los cambios hechos en el borrador, sin señalar el problema que resuelven<br>**0** — No justifica ningún cambio |
