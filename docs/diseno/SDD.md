...
**Versión 1.4** · Documento de trabajo · Agosto 2026
...
| **Catálogo de instrumentos (§7)** | 5 de 7 | Hechos 7.1, 7.2, 7.3, 7.5 y 7.6. Autoevaluación y coevaluación (`generarAutoevaluacion` en `js/motor.js`) reconjugan la matriz completa a 1.ª persona a partir del banco de verbos (ahora 34, tras sumar ocho que solo aparecían como segundo verbo de la frase); casos dorados y un invariante de todo el pack en `test/proyeccion.mjs`. Faltan rúbrica de un solo punto y escala de estimación analítica; el modo IA además necesita `descriptor_un_punto`, vacío en los doce criterios del pack |
