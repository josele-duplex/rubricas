...
**Versión 1.52** · Documento de trabajo · Septiembre 2026
...
| **1.53** | **Los nombres y las bandas de las matrices, revisados con el mismo criterio que los descriptores.** Cursiva que faltaba en 14 bandas; cinco matrices cuya banda máxima admitía el estado que el descriptor sitúa en N1 o N2 (voz y orden del tiempo en narración, tiempo verbal en expositivo Bach, grados de certeza en noticia 4.º ESO, progresión en oral 1.º Bach), reescritas para que la banda salga donde el descriptor pone el nivel; dos bandas que decían lo mismo en *Puntuación* (investigación y noticia); dos nombres —un posesivo del alumno en un componente y un calificativo vago en una dimensión del debate—. Lo que se vio y no se tocó —el escalón 1.º → 2.º Bach en ortografía, dos matrices que cuentan lo que el descriptor pide seleccionar, los nombres de componente que son un saber a secas y cuatro cosas más— queda abierto como decisión 20 de §17. Ocho packs suben de versión menor. Las 14 comprobaciones, limpias. |
| **1.52** | **Las formas de la lengua que un descriptor menciona van en cursiva, y se revisó la redacción de los diez packs.** El docente leyó en 1.º de ESO «los conectores y, pero y entonces» y vio una errata: no la hay —son tres conectores y la «y» que los enumera—, pero sin marca la mención y el uso se confunden. Convención `*así*` en los packs (§5.2): la app la pinta en cursiva, el CSV la pasa a «comillas», el motor de 1.ª persona no reconjuga lo que va dentro y los dos validadores ganan la regla **cursiva** (§10), con trampa en paridad y casos en `test/`. Cursiva en 141 menciones de nueve packs y catorce correcciones de redacción halladas al leer los 1.245 textos. Historia completa en `SDD-cambios.md`. |
