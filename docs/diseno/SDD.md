...
**Versión 1.11** · Documento de trabajo · Agosto 2026
...
| **Matriz tarea × curso (§4.3)** | 7 de 20 celdas | Texto expositivo en 1.º, 2.º, 3.º y 4.º de ESO y 1.º de Bachillerato; texto argumentativo en 3.º de ESO y 1.º de Bachillerato (confirmado en git en v1.10; pendiente de contenido en `lcl-c-fuentes-arg-1bach`, ver registro de cambios). Cada celda nueva es contenido curricular, no código: pasa por el protocolo del skill `rubricas-pack` |
...
7. **Matriz de tarea × curso** (§4.3): la he construido leyendo los criterios del decreto, pero es una lectura mía y tú das clase. Repásala, sobre todo la narración (¿llega a 3.º?) y el argumentativo incipiente en 2.º de ESO.
   - **Narración en 3.º ESO: ratificado por Josele el 2026-08-05.** Sí llega a 3.º, como ○ (residual: el foco del curso ya se ha desplazado al expositivo/argumentativo). La celda queda confirmada para S6 del plan de cierre de fase 2, que puede escribir el pack de narración sin pararse a consultarla de nuevo.
   - **Argumentativo en 2.º de ESO: sigue pendiente de repaso** antes de ejecutar S1.
...
11. **Posición de 2.º Bach en los tres ejes de progresión** (§5.4) — ampliada el 2026-08-05: el Marco Teórico no describe ningún peldaño por encima de 1.º Bach en **ninguno** de los tres ejes, autonomía incluida (su cita también culmina en «4.º ESO – 1.º BACH», no en 2.º Bach). El proyecto de Lengua no llega a 2.º Bach, así que la culminación del Marco Teórico es también su techo declarado. Falta decidir, para los tres ejes: si 2.º Bach reutiliza el mismo nivel que 1.º Bach (ambos en el techo del Marco Teórico, y la diferencia real entre los dos cursos se deja a la redacción del descriptor y al tipo de tarea, no al número de `progresion`) o si este SDD define un peldaño propio por encima — y en ese caso, con qué criterio, porque no hay fuente que lo sostenga. No bloquea nada mientras no exista un pack con criterios de 2.º Bach.
