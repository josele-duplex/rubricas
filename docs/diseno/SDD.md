...
**Versión 1.12** · Documento de trabajo · Agosto 2026
...
| **Matriz tarea × curso (§4.3)** | 9 de 20 celdas | Texto expositivo en 1.º, 2.º, 3.º y 4.º de ESO y 1.º de Bachillerato; texto argumentativo en 2.º, 3.º y 4.º de ESO y 1.º de Bachillerato (2.º y 4.º añadidos en v1.13, que además resuelve el defecto de `lcl-c-fuentes-arg-1bach` que la v1.10 dejó anotado). Faltan once: las seis de exposición oral, las tres de narración y las dos de 2.º de Bachillerato. Cada celda nueva es contenido curricular, no código: pasa por el protocolo del skill `rubricas-pack` |
