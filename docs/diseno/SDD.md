...
**Versión 1.48** · Documento de trabajo · Septiembre 2026
...
| **1.47** | **Sexta dimensión de la exposición oral: la respuesta a las preguntas del público, y la puerta que la abre no es el 3.1.** El 3.1 es producción monologada y no la sostiene en ninguno de los seis cursos —*pregunta*, *auditorio*, *coloquio* y *turno* no aparecen en el bloque de Lengua Castellana de las dos fuentes—; la sostiene el **3.2**, *«…en situaciones orales formales de carácter dialogado… con actitudes de escucha activa»*, que existe en los seis. `lcl-murcia-oral` pasa a v0.4.0 y a 36 criterios, y es el primer pack que usa dos criterios distintos. La progresión sale del 3.2 (escucha activa en 1.º ESO, cortesía y cooperación desde 2.º, *«de cierta extensión y complejidad»* en 4.º); 1.º y 2.º de Bachillerato comparten techo porque el decreto los redacta con las mismas palabras. Sin matriz cuantitativa —se observan turnos, no unidades contables—, opcional y con 15 puntos de peso sobre el 25/20/20/20/15 anterior escalado. El defecto que ningún validador ve: dieciséis segundos verbos fuera del banco se quedaban en tercera persona al proyectar la autoevaluación, reescritos con verbos del banco o en infinitivo. Historia completa en `SDD-cambios.md`. |
