...
**Versión 1.42** · Documento de trabajo · Agosto 2026
...
| **Exportación (§12)** | Parcial | Impresión y PDF funcionan. Falta configuración `.json` y el texto plano del modo IA. El `.xlsx` de iDoceo sale del alcance de la app (decisión §17.19, resuelta el 2026-08-25): lo genera el skill `rubricas-lomloe` |
