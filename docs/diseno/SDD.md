...
**Versión 1.57** · Documento de trabajo · Septiembre 2026
...
| Versión | Cambios |
|---|---|
| **1.57** | **Cierra la decisión 20(e) de §17: una sola escala contable por componente donde dos bandas contiguas describían al mismo alumno.** *Referencia y sustitución léxica* (argumentativo y expositivo, 2.º y 3.º ESO; en expositivo 2.º ESO el componente se llama *No repetir la misma palabra*): la banda de 2 («repite la palabra clave 3 o más veces teniendo sustituto evidente») y la de 1 («sustituye en 1 punto y repite en el resto») eran la misma producción vista desde dos lados; ahora se cuenta una sola cosa —la **repetición sin sustituir teniendo sustituto evidente**, y desde 3.º ESO también el **referente que exige releer**, que el N4 de expositivo pide «sin ambigüedad»— con la banda de 4 en «sin errores de referencia», 3 = hasta 1, 2 = 2 o 3, 1 = 4 o 5 con alguna sustitución, 0 = 6 o más. Pasada por los cinco cursos de los dos packs (regla 9): 4.º ESO, 1.º y 2.º Bach conservan sus dos bandas altas por mecanismo (nominalización, hiperónimo abstracto), que son otra cosa y no se tocan, pero sus bandas de 1, 0,5 y 0 tenían el mismo solape («3 o más veces» contiene «a lo largo del texto») y pasan a la misma unidad, más estricta que en 3.º (hasta 1 / 2 o 3 / 4 o más); expositivo 1.º ESO, que tenía el solape a media escala («en un solo punto» frente a «deja 2 o 3»), entra en la misma cuenta; y el pack oral, que copiaba las tres bandas bajas de 4.º ESO a 2.º Bach con sus palabras, recibe la misma corrección para no dejar el defecto vivo en otro sitio. Los cinco componentes de 1.º a 3.º ESO quedan **contables de arriba abajo** por el simulador, que hasta ahora los puntuaba por nivel. *Matización de la tesis* (argumentativo 4.º ESO) y *Gestión del contraargumento* (1.º y 2.º Bach): se invierten las bandas de 2 y 1, porque enunciar una objeción concreta y descartarla, o nombrar una postura contraria, es más que mencionar que existen otras posturas; la escala es una sola —hasta dónde llega la objeción: no existe → se menciona que hay otras posturas → se nombra una → se expone y se rebate con argumento repetido / se delimita → se rebate con argumento nuevo— y el límite entre las dos bandas invertidas se escribe («sin nombrar ninguna» / «sin rebatirla») para que no vuelvan a solaparse. *Precisión del vocabulario* (comentario 1.º ESO; y expositivo 1.º y 2.º ESO, que tenían la misma banda de 1): la banda de 1 («términos generales y algún verbo preciso») no era peor que la de 2 («3 o más términos generales»); ahora se cuentan términos de significado general (hasta 2 / 3 o 4 / 5 o más con algún verbo preciso —*describe*, *compara*— / solo palabras comodín sin ningún verbo preciso; en 2.º ESO expositivo 1 / 2 o 3 / 4 o más, por `continuidad_bandas`). Los componentes de 3.º ESO en adelante (*Precisión léxica y densidad*, *… y vocación de estilo*) miden otra cosa en sus bandas altas y no se tocan. *Ideas reunidas* (resumen 1.º ESO) y *Condensación* (3.º ESO, que tenía el mismo solape entre «ideas de 2 frases» y «en 1 punto»): la banda de 2 contaba frases del original y la de 1,5 contaba puntos del resumen; ahora es un solo eje de condensación —frases enlazadas con conjunción sin reformular → 2 frases reunidas manteniendo el molde → 2 frases reunidas en frase propia en 1 punto → en 2 o más puntos (→ 3 o más frases en una, en 3.º ESO)—. Ninguna penalización nueva, ninguna banda mide lo que ya mide otro componente. Validados los cinco packs, simulados con `--resumen`: ninguna nota de perfil cambia, sin saltos de dos niveles, umbrales planos ni ceros nuevos; revisiones regeneradas; argumentativo y expositivo 0.6.0, comentario 0.5.0, resumen 0.4.0, oral 0.8.0. |
| **1.56** | **Cierra la decisión 20(b) de §17: las dos matrices que contaban lo que el descriptor pide seleccionar miden ahora lo que se selecciona.** Comentario: el componente *Fragmentos del texto traídos al comentario* (4 puntos por «6 o más fragmentos») pasa a *Afirmaciones apoyadas en un fragmento a la medida de lo que prueba* —en 2.º Bach, *pasos del razonamiento*—, con una sola escala contable en dos tramos: la banda de 4 exige que cada afirmación lleve fragmento y que ninguno traiga más texto del que el comentario usa (el N4, «elige la extensión de cada una por lo que prueba»); la de 3, la cobertura completa con algún fragmento sobrante (el N3); las de 2 y 1 cuentan afirmaciones sin fragmento (1–2 / 3 o más). No pisa el tercer componente, que sigue contando fragmentos que prueban la misma afirmación: uno mide afirmaciones sin prueba, el otro pruebas repetidas (regla 7). La escala se pasó por los cinco cursos: entra también en 4.º ESO, cuyo N3 y N4 son los de 1.º Bach («descarta las citas que prueban lo mismo dos veces», «valor probatorio»), y se deja contando en 1.º y 3.º ESO, donde el descriptor fija él mismo el número (un fragmento por pregunta de la pauta o por apartado del guion). Investigación 3.º ESO: *Datos contrastados entre fuentes* pasa a *Fuentes entre las que contrasta el dato principal*, que es lo que dice el N3: 3 o más fuentes vale 4, 2 fuentes vale 3, un dato distinto del principal entre 2 fuentes vale 2. En 4.º ESO la banda de 4 pedía «4 o más datos» sin decir entre cuántas fuentes y el N3 dice «los datos principales entre tres fuentes de distinta procedencia»: ahora lo pide así (2 o más datos principales entre 3 o más fuentes de distinta procedencia; 2 fuentes vale 3). 1.º y 2.º Bach se quedan como estaban: sus N3 no fijan número de fuentes («entre fuentes de distinta procedencia») y sí piden la verificación del dato discrepante en una fuente primaria, que la banda de 4 ya recoge. Validados los dos packs, simulados con `--resumen` sin saltos, umbrales planos ni ceros nuevos; revisiones regeneradas; comentario 0.4.0 e investigación 0.6.0. |
| **1.55** | **Cierra la decisión 20(a) de §17: 2.º de Bachillerato ya no es más laxo que 1.º en la banda máxima de Ortografía** de argumentativo, expositivo y reacción. Banda de 4 puntos en «hasta 2 faltas» (argumentativo, expositivo) y «hasta 1» (reacción), banda de 3 desplazada un punto para no dejar hueco. Simulado con `simular_correccion.py --resumen` en los tres packs: solo el perfil «solvente» de 2.º Bach cambia, de 10,00 a 9,85. Historia completa en `SDD-cambios.md`. |
