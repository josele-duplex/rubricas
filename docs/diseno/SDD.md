...
| **1.51** | **El botón deja de llamarse «(iDoceo)»: el CSV en blanco sirve para cualquier hoja de cálculo, no solo para su importador.** Comprobado contra la documentación oficial de iDoceo que su importador de rúbricas acepta CSV o XLS y que XLSX no es compatible con la importación manual, así que la decisión de la v1.44 (`.csv`, no `.xlsx`) queda reafirmada. El rótulo sí cambia: «Exportar rúbrica (iDoceo)» sonaba a un destino único cuando el CSV se abre igual en cualquier hoja de cálculo. Pasa a **«Exportar rúbrica (CSV)»**, con su microexplicación y la guía docente reescritas en el mismo sentido. Historia completa en `SDD-cambios.md`. |
