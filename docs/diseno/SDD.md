...
**Versión 1.64** · Documento de trabajo · Septiembre 2026
...
| **1.62** | **El resumen deja de ser la fila con huecos: entra en 2.º y en 4.º de ESO (decisión 21 de §17).** La matriz §4.3 daba por vacíos los dos cursos pares porque su 4.1 es de valoración y no de comprensión. La revisión del decreto encontró dos cosas que el argumento no había mirado: el **enunciado de la competencia 4**, único para toda la materia, exige *"reconociendo el sentido global y las ideas principales y secundarias"*, y el **9.1 de 4.º ESO** añade *"e identificar y subsanar algunos problemas de comprensión lectora"*, cláusula que 1.º y 2.º no llevan. La puerta la abre un criterio en los dos cursos, así que la regla 9 no se toca. Diez criterios nuevos en `pack-lcl-resumen` (v0.5.0), prosa de §4.3 reescrita en seis pasajes —uno de ellos **corregía un error de hecho**: se decía que 2.º ESO no nombraba *"resúmenes"* en sus saberes, y sí lo nombra—. Los dos cursos entran **sin** extensión de referencia en `simular_correccion.py`, por decisión del docente: interpolarla habría sido inventar un dato de aula. |
...
Todo el diseño técnico que sigue está subordinado a estos principios, tomados del **marco teórico vigente**, que vive en el proyecto de Lengua —`proyecto/documentos_base/marco_teorico_rubricas-LOMLOE.md`, hecho H4 de la matriz digital— y no en este repositorio. Se indica entre paréntesis el apartado de origen y, en negrita, la consecuencia técnica concreta.
...
- Impresión/PDF y configuración en archivo `.json`. **La conversión a nota sobre 10 y la exportación a iDoceo son del skill `rubricas-lomloe`, no de esta app** (hecho H11 de la matriz digital; decisión §17.19, resuelta el 2026-08-25): la app construye el instrumento, el skill califica con él.
...
| Texto expositivo | ● | ○ | ● | ● | ● | ○ |
| Exposición oral | ● | ● | ● | ● | ● | ● |
| Debate y situaciones orales dialogadas | ○ | ○ |  | ● |  |  |
| Texto argumentativo |  | ○ | ● | ● | ● | ● |
...
**Una sola fila no pertenece a esa familia, y es la única con hueco en medio: el comentario de texto literario.** Las cuatro filas de arriba las abre el 5.1 (o el 3.1 en la oral), que existe redactado en los seis cursos; lo que varía de curso a curso es el foco de los saberes, nunca la existencia de la puerta. El comentario lo abre el **8.1**, que no es el mismo criterio en todos los cursos: en 1.º, 3.º y 4.º de ESO y en los dos de Bachillerato dice *"la interpretación de las obras leídas"* a partir del análisis de sus elementos, mientras que en **2.º de ESO el 8.1 es otro criterio**, el de los vínculos intertextuales. La celda vacía de 2.º ESO no es un olvido ni una decisión de alcance: es que ese año el currículo no pide esta tarea. También cambia el sentido de ●: en esta fila lo que los saberes nombran no es un género textual, sino la operación interpretativa misma, y por eso la leyenda de la tabla habla de género 'o tarea'.

**La fila del resumen también cuelga del 4.1, y el 4.1 alterna de curso en curso entre dos redacciones distintas; lo que no alterna es la competencia a la que sirve.** En los cursos impares de ESO el 4.1 es un criterio de **comprensión** —*"Comprender e interpretar el sentido global, la estructura, la información más relevante y la intención del emisor"*— y en los pares es uno de **valoración**: *"Valorar la forma y el contenido de textos escritos y multimodales sencillos evaluando su calidad, su fiabilidad y la idoneidad del canal utilizado"* en 2.º, *"Valorar críticamente el contenido y la forma de textos escritos y multimodales de cierta complejidad"* en 4.º. La alternancia es real, pero no vacía ninguna celda, porque las dos redacciones son criterios de **la misma competencia específica**, y el decreto la enuncia una sola vez para toda la materia: *"Comprender, interpretar y valorar textos escritos, con sentido crítico y diferentes propósitos de lectura, reconociendo el sentido global y las ideas principales y secundarias"*. Eso es la operación del resumen palabra por palabra, y en 2.º y en 4.º el 4.1 es el **único** criterio que sirve a esa competencia. Valorar la forma y el contenido de un texto no es resumirlo, pero en el decreto es una de las dos caras de una competencia cuya otra cara es reconocer el sentido global; y el desarrollo de la competencia lo dice sin rodeos: *"Comprender un texto implica captar su sentido global y la información más relevante en función del propósito de lectura"*. Lo que cambia de curso a curso no es si el resumen tiene puerta, sino **para qué se resume**: en 1.º y 3.º para demostrar que el texto se ha entendido, en 2.º y 4.º como paso previo a juzgarlo. En Bachillerato la alternancia se acaba porque la competencia 4 tiene **dos criterios** en vez de uno, y el 4.1 de los dos cursos es el de comprensión (*"Identificar el sentido global, la estructura, la información relevante y la intención del emisor de textos escritos y multimodales especializados"*), quedando la valoración en el 4.2. De ahí el dibujo de la fila: ● ▸ ● ▸ ● ▸ ● ▸ ○ ▸ ○.
...
- **Resumen en 2.º ESO (●):** la puerta es el 4.1 del curso, que aquí es el de valoración —*"Valorar la forma y el contenido de textos escritos y multimodales sencillos evaluando su calidad, su fiabilidad y la idoneidad del canal utilizado, así como la eficacia de los procedimientos comunicativos empleados"*—, y es el **único** criterio de la competencia 4 en el curso: la competencia que exige *"reconociendo el sentido global y las ideas principales y secundarias"* no tiene en 2.º ESO otra entrada que esta. Los saberes acompañan por partida doble: el bloque de comprensión conserva íntegra la fórmula de los cursos impares —*"Comprensión lectora: sentido global del texto y relación entre sus partes. La intención del emisor"*— y el de producción escrita nombra la tarea con todas las letras, *"Usos de la escritura para la organización del pensamiento: toma de notas, esquemas, mapas conceptuales, definiciones, resúmenes, etc."*. **La progresión entre 1.º y 2.º está escrita en esas dos frases**: donde 1.º dice *"Usos básicos de la escritura para la organización del pensamiento"*, 2.º dice *"Usos de la escritura para la organización del pensamiento"* a secas, y donde 1.º se queda en *"Comprensión lectora: sentido global del texto y relación entre sus partes"*, 2.º añade *"La intención del emisor"*. Por eso el pack de 2.º repite la línea de 1.º en lugar de reencuadrar la tarea hacia el juicio crítico. **Lo que el saber añade no se convierte en exigencia de N4**: la intención del emisor entra como `saber_vehiculo` y no como techo, porque el 4.1 de 2.º no la pide por ninguna parte —habla de calidad, fiabilidad y canal— y porque, preguntado, el docente responde que un alumno bueno de 2.º de ESO no la resuelve. El escalón sobre 1.º es el que sí hace: abrir el resumen con la idea que agrupa a las demás **aunque en el original no vaya la primera**, donde 1.º se conforma con que la idea general abra el resumen. El criterio abre la celda; el techo lo fija lo que el curso alcanza (CLAUDE.md, regla 2, y el precedente de la decisión 17).
...
- **Resumen en 4.º ESO (●):** es el único curso con dos puertas, y conviene decir cuál abre qué. El 4.1 es el de valoración crítica —*"Valorar críticamente el contenido y la forma de textos escritos y multimodales de cierta complejidad evaluando su calidad y fiabilidad"*— y sostiene la selección de lo relevante: no se juzga el contenido de un texto sin haber decidido antes cuál es. La comprensión propiamente dicha la sostiene el **9.1**, que en 4.º ESO —y no en 1.º ni en 2.º— añade una segunda mitad al criterio de revisión: *"e identificar y subsanar algunos problemas de comprensión lectora utilizando los conocimientos explícitos sobre la lengua y su uso"*. Es la única vez en toda la matriz que la puerta de una dimensión la abre la competencia 9. Los saberes nombran la tarea —*"Desarrollo de usos de la escritura para la organización del pensamiento: toma de notas, esquemas, mapas conceptuales, definiciones, resúmenes, etc."*— y 4.º es además el **único** curso en que el bloque de comprensión lectora se estrecha a la valoración: *"Comprensión lectora: Valoración de la forma y el contenido del texto"*, sin la fórmula del sentido global que llevan los otros cinco. **Los dos cursos pares se compensan en direcciones opuestas**: 2.º conserva el saber de comprensión y no tiene la cláusula del 9.1; 4.º tiene la cláusula y no conserva el saber. El 6.1 sigue sin servir aquí —pide *"Localizar, seleccionar y contrastar información de manera autónoma procedente de diferentes fuentes"*, que es investigación documental sobre varias fuentes, no la reconstrucción fiel de un texto único—, y por eso no entra en el pack.
...
- `condicion_de_evidencia` es opcional y vale `null` si no aparece. Dice **qué tiene que montar la tarea para que la dimensión se pueda observar**, y se imprime en la rúbrica analítica, que es el instrumento con el que califica el docente (§7.1). Lo pidió la sexta dimensión del pack de oral: la respuesta a las preguntas del público no depende del alumno —depende de que haya turno de preguntas y de que alguien pregunte—, y sin esa condición escrita la fila se imprime igual y se califica igual, con la evidencia a medio recoger. **No es la puerta de aplicabilidad (§8), que elige instrumento, ni la condición mínima de §6.4, que toca la nota**: no cambia el cálculo, ni desmarca la dimensión, ni la esconde. Es una instrucción de montaje, así que se redacta para el docente y no se le imprime al alumno en su ficha. Es **de la dimensión, no del curso**: el validador da error si se declara en unos cursos de la misma dimensión y en otros no (§10). El texto sí puede cambiar de un curso a otro —quién modera el turno, por ejemplo—; lo que no puede es faltar.
- **Las formas de la lengua que un texto menciona van en cursiva**, con asteriscos: *«Utiliza los conectores \*y\*, \*pero\* y \*entonces\*»*, *«palabras comodín (\*cosa\*, \*tema\*, \*hacer\*)»*. Lo pidió el descriptor de N1 de cohesión de 1.º de ESO: leído sin marca, «los conectores y, pero y entonces» parece una errata —la «y» conector y la «y» que enumera son la misma letra—. Vale para todo texto que la app pinta —descriptores, `descriptor_un_punto`, condiciones de banda, `condicion_de_evidencia`—, y solo para formas citadas (conectores, palabras, fórmulas, muletillas), nunca para conceptos («primera persona», «la impersonalidad»). La marca la conoce un solo módulo, `js/marcas.js` (`scripts/marcas.py` en Python): la interfaz la convierte en `<em>`, el CSV de iDoceo la pasa a «comillas» porque una celda no tiene cursiva, el motor de 1.ª persona no reconjuga lo que va dentro —*el autor opina* es lengua citada, no una acción del alumno— y los dos validadores aplican sus reglas a las palabras y no a los asteriscos, con una regla propia, **cursiva** (§10), para la marca que queda abierta. Se eligió el asterisco del Markdown y no las comillas porque se lee en el JSON crudo, los `docs/revision-*.md` lo pintan sin tocarlo y ningún descriptor lo necesita para otra cosa.
...
descriptor), y aporta el valor de ese nivel según la escala de §6.2. Un criterio con matriz puede
producir **cualquiera de los dos** (v1.54; hasta entonces, siempre `matriz`): `{ tipo: "nivel" }` si
el docente pincha el descriptor, y `{ tipo: "matriz" }` si abre la matriz y marca la banda de cada
componente; de este salen sus puntos por §6.3, y son esos puntos los que aportan, sin colapsar a
nivel. Su nivel se calcula aparte, por §6.4, para mostrarlo y para la condición mínima. Que el
docente pueda elegir por fila no contradice §6.2: lo que aquella prohíbe es convertir puntos
contados en nivel, no calificar por nivel cuando no se ha contado. El CSV para el importador de
rúbricas de iDoceo (§12) ya aplanaba todo criterio a cuatro niveles con la escala equilibrada.
...
**La pantalla (2) existe desde la v1.5 y desde la v1.54 es una cuadrícula** (`js/calificar.js`), al
modo de iDoceo: la misma tabla de la rúbrica analítica —dimensiones por filas, cuatro niveles por
columnas— con las celdas de descriptor pinchables y la nota en una barra fija que no se va al
desplazarse, recalculada a cada clic. La versión anterior (v1.5–v1.53) era una columna de tarjetas
con un desplegable por componente y la nota al final; con seis dimensiones, calificar exigía
desplazarse dos o tres pantallas entre marcar y ver el resultado. La pantalla guarda por dimensión
un *estado de fila* —`{ modo: "nivel", nivel }` o `{ modo: "matriz", bandas, ocurrencias }`— y no el
`ResultadoCriterio` directamente, porque una fila a medio marcar no es un resultado y no debe entrar
en la nota; la traducción en los dos sentidos (`resultadoDeFila`, `estadoDeResultado`) vive en
`js/calificacion.js` como funciones puras con casos en `test/calificacion.mjs`. Lo que se persiste
(§6.5, `localStorage`, por curso + tarea + actividad) sigue siendo el `ResultadoCriterio` de arriba,
sin cambio de formato: los alumnos calificados antes de la cuadrícula se cargan igual.
...
La matriz completa: dimensiones en filas, cuatro niveles en columnas, peso por dimensión. Cabecera con la actividad, el curso, el tipo de tarea y los criterios oficiales de referencia. Es también el único instrumento que imprime la `condicion_de_evidencia` de las dimensiones que la declaran (§5.2): va en la celda de la dimensión, bajo el criterio oficial, porque es quien califica esa fila quien tiene que haber montado la tarea para poder puntuarla.
...
| **Condición de evidencia a medias** | Una dimensión declara `condicion_de_evidencia` en unos cursos y no en otros, o la declara vacía. Lo que la tarea tiene que montar para que la fila se pueda puntuar es propio de la dimensión, no del curso (§5.2) | Error |
| **Marca de cursiva mal formada** | Un asterisco de cursiva (§5.2) sin cerrar, o abierto con un espacio dentro (`*y, *pero*`, `* y*`), en cualquier texto que la app pinta. No se convierte en cursiva: se imprime como asterisco suelto en la rúbrica y en la ficha del alumno. Las demás reglas ven las palabras, no la marca: `*bien*` sigue siendo adverbitis | Error |
...
| Formato | Contenido |
|---|---|
| `.csv` (notas) | Alumno + nota final del instrumento activo, generado desde la pantalla «Calificar» (§6.5) con lo que ya hay en `localStorage`. Para el asistente general de importación de alumnos de iDoceo, **no** para su importador de rúbricas: la app sigue calificando, iDoceo solo recibe el número. Botón «Exportar CSV» en «Calificar». Nombre automático: `Notas_{tipo}_{curso}_{mmaaaa}.csv` |
| `.csv` (rúbrica) | La matriz en blanco —criterios × niveles, con el peso de cada fila y el valor de cada nivel (§6.2, escala equilibrada)— en el formato del importador de rúbricas de iDoceo: fila = criterio, columna = nivel de mayor a menor puntuación, celda de cabecera y de criterio con dos líneas (etiqueta + peso o valor). Un CSV se abre igual en cualquier hoja de cálculo, así que sirve también para quien no usa iDoceo. Botón «Exportar rúbrica (CSV)» en la vista previa. Nombre automático: `Rubrica_{tipo}_{curso}_{mmaaaa}.csv` |
...
**Las dos exportaciones a iDoceo son caminos alternativos, no complementarios, y el docente elige por instrumento (§17.19, ampliada el 2026-08-26).** Importar la rúbrica en blanco significa calificar tocando cada celda dentro de iDoceo: la pantalla «Calificar» de este proyecto deja de usarse para ese instrumento. Exportar la nota significa seguir calificando aquí y llevar solo el número. Los dos formatos son `.csv`, no `.xlsx`: los dos importadores de iDoceo aceptan CSV, así que ninguna de las dos exportaciones necesita una librería binaria externa — coherente con «motor 100% local, sitio estático» (§1).
...
| **Fase 2 — v1 completa** | La matriz completa de tarea × curso (§4.3), los siete instrumentos, modo avanzado, validador, exportación de notas a CSV, publicación | **En curso** (ver desglose) |
| **Fase 3** | Comentario de texto literario, resumen, reacción a una noticia, redacción de una noticia, trabajo de investigación multimodal. Banco de criterios favoritos | **Casi cerrada** — los cinco tipos de tarea están escritos, todos dados de alta sin tocar código: **comentario de texto literario** (`data/pack-lcl-comentario.json` v0.2.0, 5 cursos, 29 criterios), **resumen** (`data/pack-lcl-resumen.json` v0.1.0, 4 cursos, 20 criterios), **reacción a una noticia** (`data/pack-lcl-reaccion.json` v0.1.0, 4 cursos, 18 criterios), **redacción de una noticia** (`data/pack-lcl-noticia.json` v0.1.0, 5 cursos, 24 criterios) y **trabajo de investigación multimodal** (`data/pack-lcl-investigacion.json` v0.2.0, 5 cursos, 27 criterios). Falta solo el banco de criterios favoritos |
...
| **Exportación (§12)** | Parcial | Impresión, PDF y las dos exportaciones a `.csv` de iDoceo funcionan: notas (desde «Calificar») y rúbrica en blanco (desde la vista previa, botón «Exportar rúbrica (CSV)»), caminos alternativos que elige el docente por instrumento (decisión §17.19, ampliada el 2026-08-26). Falta configuración `.json` y el texto plano del modo IA |
| **Publicación** | **Terminada** | Repositorio público, validación automática en cada empujón, GitHub Pages sirviendo la app en `https://josele-duplex.github.io/rubricas/` (decisión §17.9, resuelta el 2026-08-25) |
...
exportación `.xlsx` ya no es pieza de este roadmap: sale del alcance de la app junto con la
conversión a nota (decisión §17.19).
...
1. ~~**Condición mínima de los criterios obligatorios**~~ (§6.2) — **Resuelto el 2026-08-25.** Queda desactivada por defecto: la nota sale de la suma ponderada sin techo. Sigue disponible como opción manual por instrumento para quien la anuncie de antemano.
2. ~~**Escala por defecto**~~ (§6.2) — **Resuelto el 2026-08-25.** Se confirma la escala equilibrada (2,5 / 5 / 7,5 / 10): un alumno que entrega algo, aunque flojo, no saca cero en esa dimensión.
3. ~~**Tope de los detractores**~~ (§6.3) — **Resuelto el 2026-08-25.** Se mantienen los 2 puntos sobre 10 ya implementados; no hay una convención de departamento distinta que aplicar. Sigue sin contrastarse con las directrices EBAU de Murcia a propósito: la calificación de un curso oficial se rige por el currículo, no por los criterios de corrección de una prueba externa (§7.7).
...
6. ~~**Rúbrica holística**~~ (Marco Teórico §6.1) — **Resuelto el 2026-08-25: se descarta por ahora.** Se queda con los siete instrumentos actuales; ninguna tarea de los nueve packs es tan acotada como para pedir una escala única sin desglose. Reabrir si aparece un caso de uso real de diagnóstico rápido.
...
9. ~~**Publicación**~~ (§16.1) — **Resuelto el 2026-08-25: ya estaba hecho y esta sección no se había enterado.** El repositorio `josele-duplex/rubricas` es público y GitHub Pages ya sirve la aplicación en `https://josele-duplex.github.io/rubricas/` (comprobado por API: `private: false`, `has_pages: true`; la URL responde con la aplicación cargada). Se revisó `fuentes/_originales/` como parte de esta decisión —los dos `.docx` son un borrador de marco teórico y un borrador antiguo del SDD, sin datos personales ni nada sensible— y no hay nada que retirar antes de la difusión ya en marcha.
...
19. ~~**El solape con el skill `rubricas-lomloe`: quién convierte a nota y quién exporta a iDoceo.**~~ Abierta el 2026-08-13 al cerrar la decisión 8, que la arrastraba dentro sin nombrarla, y **resuelta el 2026-08-25.** Era el hecho **H11 de la matriz digital, el único que seguía sin dueño**, y la contradicción **C3**: la app calculaba la nota sobre 10 (§6.2-§6.4) y prometía exportar el `.xlsx` de iDoceo (§4.1, §12), y el skill hace exactamente esas dos cosas; el marco vigente, además, se las atribuye al skill en su §2.3 y su §7.3.

    **Se adopta la división que recomendaba la matriz §3: la app construye el instrumento, el skill califica con él.** La app tiene el currículo delante —deriva del criterio, valida el pack, genera la rúbrica y la ficha— y conserva el cálculo interno, porque lo necesita para la pantalla de «Calificar» (§6.5), la vista previa y el simulador. Pero deja de prometer la exportación a iDoceo: esa línea sale de §4.1 y de la fase 2 del roadmap (§16.1). Calificar la producción de un alumno concreto y generar el `.xlsx` de iDoceo pasa a ser tarea del skill `rubricas-lomloe`, que tiene delante la producción del alumno. Con esto H11 tiene dueño y C3 queda cerrada sin tocar el proyecto de Lengua, cuyo marco ya atribuía esas dos funciones al skill.

    **Ampliada el 2026-08-26: «el skill califica» no significaba «solo el skill exporta».** La pregunta del docente —¿puede calificar en el instituto, sin conexión ni IA, y llevar la nota a iDoceo sin pasar por el chat?— destapó que la pantalla «Calificar» (§6.5) ya calificaba dentro de la app, en `localStorage`, sin IA (regla 8 de `CLAUDE.md`): la división de arriba daba a entender que calificar era del skill, y no lo es, nunca lo fue. Lo que de verdad tocaba decidir era otra cosa, investigada aparte: iDoceo tiene **dos** importadores distintos, uno de rúbricas (matriz de criterios × niveles, para calificar dentro de iDoceo tocando cada celda) y otro general de alumnos (una fila por alumno, con la nota ya puesta). Confirmado con el docente que sigue calificando en esta app, así que el que le sirve es el segundo. La app exporta ahora un `.csv` con Alumno + nota final del instrumento activo (`js/calificar.js`, botón «Exportar CSV» junto a la lista de alumnos guardados), para ese importador general — no construye el `.xlsx` de matriz para el importador de rúbricas, que exigiría calificar en iDoceo y dejaría de usarse la pantalla «Calificar» de este proyecto. El escape de comas es el detalle que rompe esto si se pasa por alto: los alumnos se escriben «Apellidos, Nombre» (mismo campo, mismo formato en toda la pantalla), así que casi todas las celdas de la primera columna llevan una coma dentro del propio dato y se citan con `"…"` siguiendo RFC 4180 — comprobado con un nombre real que además lleva comillas, `García Ruiz, Elena` y `Álvarez "Nena", Bea`, tanto en Node como en el navegador real tras guardar y exportar. El reparto de H11/C3 con el skill no cambia: sigue siendo quien califica cuando se le pide desde el chat; lo que cambia es que calificar-en-la-app-y-listo ya no necesita el skill para nada, ni siquiera para la nota que llega a iDoceo.

    **Ampliada otra vez el mismo día: la premisa «exigiría calificar en iDoceo» era cierta, pero no era razón para no construirla — es al docente a quien le toca elegir, no a esta decisión por él.** Las dos vías de iDoceo no compiten por lo mismo: quien prefiera tocar la rúbrica dentro de iDoceo en clase, en vez de marcar niveles en «Calificar», tiene que poder hacerlo sin esperar a que alguien decida por él que no. Se añade la segunda exportación —`.csv` con la matriz en blanco, formato del importador de rúbricas de iDoceo— junto a la del `.csv` de notas, y las dos conviven en el mismo instrumento sin conflicto porque son alternativas: se usa una o la otra según dónde se califique, nunca las dos para la misma corrección. Formato confirmado leyendo la imagen de ejemplo de la documentación oficial de iDoceo (no está en el texto, solo en `xls-format-example.png`): fila = criterio con «nombre + peso%» en dos líneas en la columna A, columna = nivel de mayor a menor puntuación con «etiqueta + valor» en dos líneas en la fila 1, celda = descriptor. Los valores de nivel son los mismos `valorNivel` de la escala equilibrada que usa «Calificar» (§6.2), así que si algún día se comparan las dos vías sobre el mismo alumno, la aritmética coincide. CSV y no XLSX en las dos exportaciones: los dos importadores de iDoceo aceptan CSV (confirmado en el foro oficial), así que ninguna pide una librería binaria externa. Botón «Exportar rúbrica (iDoceo)» junto a «Ajustar» y «Calificar» en la vista previa, con su propia microexplicación («¿esto sustituye a «Calificar»?») para que quede claro que es la otra vía, no un tercer paso. Probado con los criterios reales de un pack cargado en el navegador: cabecera y primera columna citadas por el salto de línea interno (RFC 4180), pesos y descriptores completos.

20. **Lo que la revisión de matrices de la v1.53 vio y no tocó, porque pide el criterio de quien da clase y no la traducción de un descriptor.** Abierta el 2026-09-15. La revisión leyó las 189 matrices con la pregunta del paso 4 del skill `rubricas-pack` —*¿sale el nivel que pondría el profesor leyendo el descriptor?*— y corrigió lo que era traducción. Queda esto, en siete mitades independientes, cada una cerrable por separado:

    **(a) ~~Ortografía: 2.º de Bachillerato es más laxo que 1.º en la banda máxima.~~ — Resuelto el 2026-09-15 (v1.55).** Cerrado solo el escalón que pedía la decisión —la banda máxima—, en los tres packs: la banda de 4 de Ortografía en 2.º Bach pasa de «hasta 3 faltas» a «hasta 2» en argumentativo y expositivo (550 palabras: 0,36 faltas/100, por debajo del 0,40 de 1.º Bach) y de «hasta 2» a «hasta 1» en reacción (320 palabras: 0,31 faltas/100, por debajo del 0,36 de 1.º Bach); la banda de 3, contigua, se desplaza un punto en los tres para no dejar un hueco sin banda que aplicar (`continuidad_bandas`). **La banda de 0 se queda como estaba**: la decisión, leída literal, acota «la banda máxima», y la de reacción que también aflojaba en 2.º Bach es un juicio distinto, sin abrir aparte porque nadie lo ha pedido todavía. Simulado con `simular_correccion.py --resumen` en los tres packs: única diferencia frente al cierre anterior, el perfil «solvente» de 2.º Bach baja de 10,00 a 9,85 —el único que rozaba el antiguo umbral—, sin saltos de dos niveles, umbrales planos ni ceros nuevos en ninguno de los tres. *Texto original: Medido en la unidad que fijó la decisión 17(a), faltas por cada cien palabras sobre la extensión de `simular_correccion.py`: argumentativo y expositivo admiten en la banda de 4 **0,55 faltas/100 en 2.º Bach frente a 0,40 en 1.º Bach** («hasta 3 faltas» en 550 palabras frente a «hasta 2» en 500), y el N3 de 2.º Bach dice «sin errores ortográficos, gramaticales ni tipográficos del nivel»; reacción alterna ≤1 y ≤2 faltas entre cursos (2.º ESO ≤1, 4.º ESO ≤2, 1.º Bach ≤1, 2.º Bach ≤2) y en la banda de 0 también afloja en 2.º Bach. **El resumen no entra aquí**: su escala idéntica de 1.º ESO a 2.º Bach (≤1 / 8 o más) sobre un texto que va de 60 a 130 palabras *es* la progresión, como dejó escrito la 17(a). Lo que hay que decidir es solo el escalón 1.º → 2.º Bach: «2.º Bach nunca más laxo que 1.º Bach» en los tres packs, con la banda de 4 de 2.º Bach en «hasta 2 faltas» (argumentativo, expositivo) y la de reacción alineada. Modelo para cerrarla: Sonnet, sesión nueva. Es aritmética sobre una tabla ya localizada —tres packs, un componente, dos bandas— más `simular_correccion.py --resumen` en los tres; no hay juicio de descriptor que hacer.*

    **(b) ~~Dos matrices cuentan lo que el descriptor pide seleccionar.~~ — Resuelto el 2026-09-15 (v1.56).** Lo que se cuenta, decidido por el descriptor de cada curso y no por el pack: en el comentario, **valor probatorio** —afirmaciones que se quedan sin fragmento y fragmentos que traen más texto del que se usa—, y en la investigación de 3.º ESO, **fuentes por dato**, no datos sueltos. El componente del comentario deja de llamarse por lo que traía y pasa a llamarse por lo que apoya (*Afirmaciones apoyadas en un fragmento a la medida de lo que prueba*; en 2.º Bach, *pasos del razonamiento*), y su escala es una sola: 4 = cada afirmación con fragmento y ninguno sobrante; 3 = cada afirmación con fragmento y alguno sobrante; 2 = 1 o 2 afirmaciones sin fragmento; 1 = 3 o más; 0 = sin fragmentos. El alumno que cita cinco bien elegidos tiene ahora 4, y el que trae tiradas enteras explicadas al final (N1) cae a 1 sin pasar por el tercer componente, que sigue midiendo solo la redundancia: sin doble castigo. Pasada por los cinco cursos (regla 9): 4.º ESO entra en la misma escala porque su N3 y su N4 dicen lo mismo que los de Bach; 1.º y 3.º ESO siguen contando fragmentos porque ahí es el propio descriptor el que fija cuántos (uno por pregunta de la pauta, uno por apartado del guion). En la investigación, la banda de 3.º ESO mide lo que dice su N3 (el dato principal entre 3 o más fuentes = 4; entre 2 = 3; otro dato entre 2 fuentes = 2); 4.º ESO se alinea con el suyo (datos principales entre 3 o más fuentes de distinta procedencia); 1.º y 2.º Bach ya eran coherentes con los suyos, que no fijan número de fuentes y sí la verificación en fuente primaria. *Texto original:* Comentario 1.º y 2.º Bach, *Fragmentos del texto traídos al comentario*: «6 o más fragmentos» vale 4 puntos mientras el N3 dice «descarta las citas redundantes» y el N4 «elige la extensión de cada una por lo que prueba»; el tercer componente («cada fragmento prueba una afirmación distinta») compensa, pero el alumno que cita cinco bien elegidos se queda en 3. Investigación 3.º ESO, *Datos contrastados entre fuentes*: la banda de 4 pide «3 o más datos entre dos fuentes al menos» y el N3 pide «el dato principal entre tres fuentes»; el alumno que hace exactamente lo que dice el N3 cae en la banda de 2. Cerrar cada una decidiendo qué se cuenta: número de citas o valor probatorio; número de datos o número de fuentes por dato. *Modelo para cerrarla: **Opus**. Hay que reescribir bandas para que traduzcan un descriptor que pide seleccionar, y comprobar que la escala nueva sigue siendo contable y no invalida los cursos vecinos (regla 9): es el mismo trabajo de la v1.53, no una sustitución.*

    **(c) ~~Tres componentes cuyo nombre no dice lo que miden sus bandas bajas.~~ — Resuelto el 2026-09-15 (v1.58), renombrando los tres.** Los tres resultaron ser, casi banda a banda, el componente de un curso o una fila vecina con la banda superior sustituida por el verbo nuevo del curso, así que renombrar no inventaba nada: **Expositivo 4.º ESO**, *Valoración de la fiabilidad de las fuentes* → **Atribución de los datos y valoración de su fiabilidad** (sus bandas 3 a 0 son literalmente las de *Atribución de los datos* de 3.º ESO, y la banda 4 es el juicio de fiabilidad que el criterio de 4.º pide con todas las letras: «calibrando su fiabilidad y pertinencia»). **Argumentativo 3.º ESO**, *Distinción entre dato y opinión* → **Reformulación de la fuente y distinción entre dato y opinión** (las bandas 0,5 y 0 miden copia frente a reformulación, el mismo objeto que *Reformulación frente a copia* del expositivo del mismo curso; solo 1/1,5/2 miden la distinción). **Investigación 1.º y 2.º Bach**, *Apartados con título propio* → **Jerarquización de los epígrafes** (en 4.º ESO, curso vecino, el nombre sí describe la banda; en 1.º y 2.º Bach las cinco bandas cuentan «epígrafes jerarquizados», otro objeto). Ninguna banda cambia de redacción ni de puntos: la nota de ningún alumno se mueve. Las calificaciones ya guardadas en el navegador del docente para esos tres componentes quedan huérfanas, porque `js/calificacion.js` indexa `bandasElegidas` por `comp.nombre` — es la misma cuestión que deja abierta la decisión 20(d). Validados los tres packs, simulados con `--resumen` en los cuatro cursos tocados: mismas notas que antes del cambio. *Texto original: Expositivo 4.º ESO, Valoración de la fiabilidad de las fuentes: las bandas 3 a 0 miden la atribución («indica el origen de cada dato», «indica las fuentes al final»…), no la fiabilidad. Argumentativo 3.º ESO, Distinción entre dato y opinión: las bandas 0,5 y 0 miden copia frente a reformulación. Investigación 1.º y 2.º Bach, Apartados con título propio: las bandas hablan de «epígrafes jerarquizados», que es otro objeto. O se renombra el componente por lo que mide de verdad, o se reescriben las bandas bajas para que midan lo que dice el nombre. Modelo para cerrarla: Sonnet si se elige renombrar —tres cadenas, revisiones regeneradas, y anotar que las calificaciones guardadas de esos tres componentes se pierden—; Opus si se reescriben las bandas, por lo mismo que en (b).*

    **(d) ~~La regla 5 aplicada a los nombres de componente.~~ — Resuelto el 2026-09-16 (v1.60): se queda como está, decisión del docente.** Josele confirma la lectura de la v1.53: lo que orienta a alumnado y profesorado es el nombre de la **fila** (la dimensión, «una acción competencial»); el componente solo etiqueta lo que se cuenta dentro de esa fila, y lo que de verdad dice qué se valora son las bandas («sin errores», «hasta 1 error»…), no la etiqueta del componente. No se renombra ninguno de los veinte. Con esto no hace falta tocar `js/calificacion.js` ni `js/calificar.js`, ni la indexación de `bandasElegidas` por `comp.nombre`: las calificaciones ya guardadas en el navegador del docente para esos componentes siguen siendo válidas. *Texto original: Una veintena de componentes se llaman por un saber a secas: Puntuación, Concordancia, Adjetivación, Persona gramatical, Léxico valorativo, Discurso referido, Punto de vista, Conectores temporales, Recursos de estilo, Convenciones del género, Formas verbales del relato, Pirámide invertida, Titulación, Extensión, Registro, Objetividad, Contraste, Condensación, Cierre, Conclusión. La lectura de la v1.53 es que la regla apunta a la fila, que es la dimensión —«la dimensión es una acción competencial»—, y que el componente etiqueta lo que se cuenta mientras la banda hace de descriptor; el validador comprueba la cabeza de la dimensión y no el componente por esa razón. Si se decide lo contrario, el coste no es de redacción: la pantalla «Calificar» guarda las bandas elegidas indexadas por comp.nombre (js/calificacion.js, resultadoDeFila, bandasElegidas[comp.nombre]), así que renombrar un componente deja huérfana la calificación guardada de ese componente en el navegador del docente. Habría que renombrar con una migración o aceptar la pérdida, y decirlo en el registro. Modelo para cerrarla: primero la decisión, que es del docente y no necesita modelo; si se aplica, Opus, porque toca js/calificacion.js y js/calificar.js (indexar las bandas elegidas por posición o por un id de componente nuevo en data/esquema-pack.json, con su prueba en test/) además de una veintena de nombres en ocho packs, y una regla nueva en los dos validadores con su caso en comprobar_paridad.py.*

    **(e) ~~Orden dudoso entre bandas contiguas~~ — Resuelto el 2026-09-15 (v1.57).** Una sola escala contable por componente, en los cuatro casos y en los sitios donde el mismo solape vivía sin que la decisión lo nombrara. *Referencia y sustitución léxica*: se cuenta la repetición sin sustituir teniendo sustituto evidente (desde 3.º ESO, también el referente que exige releer): sin errores / hasta 1 / 2 o 3 / 4 o 5 con alguna sustitución / 6 o más; pasada por los cinco cursos de los dos packs, las bandas bajas de 4.º ESO a 2.º Bach —que tenían el mismo solape entre «3 o más veces» y «a lo largo del texto»— pasan a la misma unidad, más estricta (hasta 1 / 2 o 3 / 4 o más), sin tocar sus dos bandas altas por mecanismo; entran también expositivo 1.º ESO y las tres bandas bajas del pack oral, que las copiaba. *Matización de la tesis* y *Gestión del contraargumento*: invertidas las bandas de 2 y 1, con el límite escrito («sin nombrar ninguna» / «sin rebatirla»). *Precisión del vocabulario*: se cuentan términos de significado general (hasta 2 / 3 o 4 / 5 o más con algún verbo preciso / solo comodín sin ninguno), también en expositivo 1.º y 2.º ESO, que tenían la misma banda de 1. *Ideas reunidas* y *Condensación* (resumen 1.º y 3.º ESO): un solo eje —conjunción sin reformular → 2 frases con el molde del original → 2 frases en frase propia en 1 punto → en 2 o más puntos—. Simulado en los cinco packs: ninguna nota de perfil cambia y nada mecánicamente sospechoso. *Texto original:* sin contradecir al descriptor: *Referencia y sustitución léxica* en argumentativo y expositivo 2.º y 3.º ESO (la banda de 2, «repite la palabra clave 3 o más veces teniendo sustituto evidente», y la de 1, «sustituye la palabra clave en 1 punto y la repite en el resto», describen al mismo alumno); *Matización de la tesis* (argumentativo 4.º ESO) y *Gestión del contraargumento* (1.º y 2.º Bach), donde enunciar una objeción y descartarla vale 1 y mencionar que existen otras posturas vale 2, cuando lo primero es más que lo segundo; *Precisión del vocabulario* en comentario 1.º ESO (la banda de 1, «términos generales y algún verbo preciso», no es peor que la de 2, «3 o más términos generales»); *Ideas reunidas* en resumen 1.º ESO (la banda de 2 cuenta ideas reunidas en una frase y la de 1,5 cuenta puntos del resumen: dos escalas). En cada caso, una sola escala contable por componente. *Modelo para cerrarla: **Opus**. Las dos primeras están copiadas en cinco cursos de dos packs, así que la escala nueva se pasa por todos a la vez, y el orden entre bandas es exactamente el juicio que `continuidad_bandas` no hace.*

    **(f) Dos cabezas de dimensión que nombran un contenido y no una acción**, aunque pasan el validador porque no están en `saberes_prohibidos`: «Metalenguaje: términos del análisis literario» (comentario Bach; sería «Uso del metalenguaje: …») y «Elementos no verbales: mirada, postura y gesto» (oral, seis cursos; sería «Apoyo no verbal: …»). Cambiar un nombre de dimensión no toca calificaciones guardadas —se indexan por `id` de criterio— pero sí las tablas §4.3 y §5.4 generadas y las revisiones docentes. *Modelo para cerrarla: **Sonnet**, sesión nueva. Dos cadenas en dos packs, `generar_tablas_sdd.py`, `generar_revision.py` y `comprobar_todo.py` limpio; si `verificar_derivacion.py` protesta por la cabeza nueva, es señal de parar y no de forzar.*

    **(g) La banda máxima de *Explica alguna mejora* (argumentativo y expositivo 2.º ESO) pide «al menos un cambio» y el N4 dice «cada cambio».** Es la única contradicción del mismo tipo que las cinco de la v1.53 que no se reescribió, porque en los cursos bajos la laxitud de la banda puede ser deliberada —«en 1.º de ESO hay que fomentar el trabajo y el esfuerzo por encima del resultado», decisión 17—; pero 2.º no es 1.º, y o la banda dice «cada cambio» o el N4 dice «al menos uno». *Modelo para cerrarla: **Sonnet**. Una decisión de una línea y una cadena en dos packs.*

21. ~~**El resumen en 2.º y 4.º de ESO: dos celdas que la matriz daba por vacías.**~~ Abierta y **resuelta el 2026-09-16 (v1.62)**, a instancia del docente: el departamento obliga a resumir el texto base de los exámenes, y el resumen se trabaja en todos los cursos de secundaria. La pregunta no era si la tarea existe en el aula —existe—, sino si el currículo abre la puerta, porque la regla 9 de `CLAUDE.md` no admite abrir una celda con un saber.

    **La abre, y el argumento anterior no lo había mirado.** §4.3 sostenía que el 4.1 alterna entre comprensión (cursos impares) y valoración (pares) y que solo la redacción de comprensión sostiene un resumen. La alternancia es cierta; la conclusión, no: las dos redacciones son criterios de **la misma competencia específica**, y el decreto la enuncia una sola vez para toda la materia —*"Comprender, interpretar y valorar textos escritos, con sentido crítico y diferentes propósitos de lectura, reconociendo el sentido global y las ideas principales y secundarias"*—, con el desarrollo diciéndolo aún más claro: *"Comprender un texto implica captar su sentido global y la información más relevante en función del propósito de lectura"*. En 2.º y en 4.º el 4.1 es el **único** criterio que sirve a esa competencia. La puerta es un criterio de evaluación en los seis cursos, así que **la regla 9 no se toca ni se le declara excepción**: lo que se corrige es una lectura del criterio, no la regla.

    **4.º ESO tiene además una segunda puerta que nadie había examinado.** El análisis anterior descartó el 6.1 —y sigue descartado, porque es investigación documental sobre varias fuentes— pero no llegó al **9.1**, que en 4.º ESO, en 3.º y en los dos de Bachillerato, y **no** en 1.º ni en 2.º, añade al criterio de revisión *"e identificar y subsanar algunos problemas de comprensión lectora utilizando los conocimientos explícitos sobre la lengua y su uso"*. En el pack de 4.º, el 9.1 sostiene la comprensión y el 4.1 la selección de lo relevante.

    **Los dos cursos pares se compensan en direcciones opuestas**, y por eso no se redactan igual. 2.º conserva íntegro el saber de comprensión de los impares —*"Comprensión lectora: sentido global del texto y relación entre sus partes. La intención del emisor"*— y no tiene la cláusula del 9.1; 4.º tiene la cláusula y es el **único** curso en que ese saber se estrecha a *"Comprensión lectora: Valoración de la forma y el contenido del texto"*. Decidido con el docente: **2.º se redacta pegado a 1.º**, en vez de reencuadrar la tarea hacia el juicio crítico; 4.º se sitúa entre 3.º y 1.º Bach. El primer intento puso en el N4 de 2.º la intención del emisor, porque es lo que sus saberes añaden a los de 1.º, y **el docente lo rechazó: un alumno bueno de 2.º no lo hace**. El 4.1 del curso tampoco la pide, así que la intención se queda en `saber_vehiculo` y el N4 sube un solo peldaño real sobre 1.º —abrir el resumen con la idea que agrupa a las demás aunque en el original no vaya la primera—. Es el mismo criterio de la decisión 17: un saber es vehículo, no techo, y el techo de los cursos bajos lo fija quien da clase.

    **Un error de hecho de §4.3, corregido de paso.** El pasaje de 2.º ESO afirmaba que «el bloque de producción escrita de 2.º ESO tampoco repite la fórmula de 'resúmenes' que sí tienen 1.º, 3.º y 4.º». La repite: los cuatro cursos de ESO la llevan, y con la progresión escrita dentro —*"Usos básicos de la escritura"* (1.º), *"Usos de la escritura"* (2.º), *"Profundización en los usos"* (3.º), *"Desarrollo de usos"* (4.º)—. `verificar_derivacion.py` no lo detectó **y no podía**: comprueba que lo entrecomillado exista en la fuente, y esto era una afirmación negativa, que no tiene cita que contrastar. Queda anotado como límite conocido del verificador; cerrarlo pediría comprobar ausencias declaradas, que es otra herramienta y no se abre aquí.

22. **Lenguaje sencillo para lo que lee el alumno: la infraestructura está hecha, la decisión de arquitectura que le corresponde a Lengua sigue sin constar.** Abierta el 2026-09-25 al cerrar la sesión L1 de `docs/diseno/plan-lenguaje-sencillo.md`.

    **Lo que ya existe (v1.63).** Cada descriptor puede llevar una segunda redacción, `alumno: {verbo, texto, origen}` (`data/esquema-pack.json`), y cada criterio un `nombre_alumno`; `origen` es la huella FNV-1a de 32 bits del `texto` técnico del que salió el sencillo, calculada igual en `js/huella.js` y `scripts/huella.py` (paridad comprobada en `scripts/comprobar_paridad.py`). Los dos validadores aplican a `alumno.texto` las mismas reglas de verbo, adverbitis y cursiva que al técnico, más `alumno_desfase`: si el técnico se edita después y `origen` deja de coincidir con su huella actual, es error, y `generarFichaAlumno`/`generarAutoevaluacion` (`js/motor.js`) dejan de usar ese sencillo hasta que se vuelva a cargar — los instrumentos del profesor no lo usan nunca. `scripts/cargar_sencillo.mjs` escribe un borrador validado en el pack sin editar JSON a mano, y `docs/revision-*.md` gana una tabla técnico · sencillo · sencillo en 1.ª persona por descriptor que la tiene, esta última proyectada con la misma `primeraPersona()` del motor. Ningún pack lleva todavía contenido: las 15 comprobaciones dan lo mismo antes y después.

    **Primer contenido (v1.64, sesión L2).** El argumentativo de 4.º ESO lleva versión sencilla en sus seis dimensiones —24 descriptores y seis `nombre_alumno`—, cargada con `scripts/cargar_sencillo.mjs` y revisada en su significado por el docente. El borrador del que salió se ha borrado: la fuente es el pack. Es el único pack y curso con contenido; el resto espera a que el docente prepare la actividad (regla 2 del plan, bajo demanda).

    **Lo que falta y no le corresponde a esta sesión.** Añadir una versión para el alumno es arquitectura de rúbrica, y esa clase de decisión es de Lengua (matriz digital §2, hecho H4): quién manda sobre los cuatro niveles, los nombres canónicos y el principio del vehículo. `docs/diseno/plan-lenguaje-sencillo.md` (sección L0) fija el párrafo pendiente de escribir en `proyecto/documentos_base/marco_teorico_rubricas-LOMLOE.md` —*cada descriptor tiene una versión técnica para calificar y una sencilla para el alumno, con el término técnico entre paréntesis; la sencilla dice lo mismo, ni más ni menos*—, y esta decisión se cierra cuando conste ahí, no aquí: este SDD solo la referencia, nunca la copia, por la misma regla que ya sostiene el marco teórico vigente (§18).

---

## 18. Fuentes del diseño

- **Marco teórico vigente** — fuente normativa de todo el diseño pedagógico de este SDD. Vive en el proyecto de Lengua: `proyecto_plan_de_trabajo_lengua/proyecto/documentos_base/marco_teorico_rubricas-LOMLOE.md`. Se referencia, no se copia (matriz digital §2, hecho H4). `scripts/verificar_derivacion.py` lo lee de ahí para comprobar las citas del SDD, y **no fija la ruta**: prueba varias candidatas dentro del repositorio hermano —la distribución de ahora, la anterior a la reestructuración de agosto de 2026 y, si ninguna acierta, una búsqueda por nombre—, con `RUBRICAS_MARCO_TEORICO` por encima de todas ellas.
