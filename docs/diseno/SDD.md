...
22. ~~**Lenguaje sencillo para lo que lee el alumno: una versión técnica y una sencilla de cada descriptor.**~~ Abierta el 2026-09-25 al cerrar la sesión L1 de `docs/diseno/plan-lenguaje-sencillo.md` y **resuelta el 2026-09-26 (v1.65)**, cuando la decisión pasó a constar en el marco teórico de Lengua.
    ...
    **Dónde consta.** Añadir una versión para el alumno es arquitectura de rúbrica, y esa clase de decisión es de Lengua (matriz digital §2, hecho H4). Consta en el §2.4 de `proyecto/documentos_base/marco_teorico_rubricas-LOMLOE.md`, «Doble versión del descriptor: técnica y sencilla» (commit `4bc8c61` de aquel repositorio), con un inciso en su §7.4 que hace salir de la versión sencilla la versión en «yo» de la autoevaluación y la coevaluación. Este SDD solo la referencia, nunca la copia, por la misma regla que ya sostiene el marco teórico vigente (§18). Lo que el §2.4 fija es lo que esta aplicación ya hacía: la técnica califica y la sencilla dice lo mismo, ni más exigencia ni menos, con el término técnico entre paréntesis; si la técnica cambia, la sencilla se rehace (aquí, `alumno_desfase`), y si no existe, el alumno lee la técnica.
